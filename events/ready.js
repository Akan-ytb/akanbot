...
module.exports = {
    ...
    async execute(client) {
        ...
        client.user.setActivity(status, { type: type, url: "https://twitch.tv/akanytb"});
         console.log("Akan Bot")
          console.log("---------------------------------------")
...
if (db.get('stream') === null) return client.user.setActivity(`${client.users.cache.size} utilisateurs !`, { type: "WATCHING", url: 'https://www.twitch.tv/akanytb' });
if (db.get('stream') === undefined) return client.user.setActivity(`${client.users.cache.size} utilisateurs !`, { type: "WATCHING", url: 'https://www.twitch.tv/akanytb' });
if (db.get('stream') === false) return client.user.setActivity(`${client.users.cache.size} utilisateurs !`, { type: "WATCHING", url: 'https://www.twitch.tv/akanytb' });
        }
    }
