...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (img == null) img = "https://media.discordapp.net/attachments/1321051084676141151/1321219173292052510/akan_youtube.png?ex=676c70bd&is=676b1f3d&hm=4b8eaba678fa1392f83677b2e1232eff27f98540dceed2dd1755a2ac50db028f&=&format=webp&quality=lossless&width=640&height=640"
        ...
        if (args[0] === "all") {
            ...
            const imgperm = "https://media.discordapp.net/attachments/1321051084676141151/1321219173292052510/akan_youtube.png?ex=676c70bd&is=676b1f3d&hm=4b8eaba678fa1392f83677b2e1232eff27f98540dceed2dd1755a2ac50db028f&=&format=webp&quality=lossless&width=640&height=640"
                    ...
                    .addOptions([
                        {
                            label: 'Accueil',
                            value: 'accueille',
                            emoji: '<:Membres:1320491629857214495>',
                        },
                        {
                            label: 'Owner',
                            value: 'owner',
                            emoji: '<a:26854crownlightyellow:1320216946007871508>',
                        },
                        {
                            label: 'Owner 2',
                            value: 'owner2',
                        ...
                        },
                        {
                            label: 'Propriétaire',
                            value: 'buyer',
                            emoji: '<:9358shinyblueowner:1320021808833105990>',
                        },
                        {
                            label: 'Antiraid',
                            value: 'antiraid',
                            emoji: "<:permsecur:962709648455135362>",
                        },
                        {
                        ...
                        },
                        {
                            label: 'Utilitaire',
                            value: 'utilitaire',
                            emoji: "<:IconCommunityPublic:1113559266717089974>",
                        },
                        {
                            label: 'Musique',
                            value: 'music',
                            emoji: "<a:Music:1067113630392393730>",
                        },
                        {
                            label: 'Modération',
                            value: 'moderation',
                            emoji: "<:8417shinybluemoderator:1320021815799709749>",
                        },
                        {
                            label: 'Logs',
                            value: 'logs',
                            emoji: "<:logs:1242218418367631373>",
                        },
                        {
                            label: 'Giveaway',
                            value: 'giveaway',
                            emoji: "<:giveaway_snoway:1265077453756563486>",
                        },
                        {
                            label: 'Jeux',
                            value: 'jeux',
                            emoji: "<:gamedevelopment:1114154313250517012>",
                        },
                        {
                            label: 'Activity',
                            value: 'activity',
